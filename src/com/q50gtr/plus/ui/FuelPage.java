...
/**
 * Вкладка ТОПЛИВО: LPFP и HPFP, под ними четыре карточки.
 *
 * LPFP стоит на месте по эталону, но значения не показывает: низкое давление
 * топлива не логируется текущей конфигурацией EcuTek.
 */
